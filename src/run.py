...
x_tr, x_te, y_tr, y_te = data_generator(128, num_images = 100, rotation_degs= range(15, 360, 15), download_from_cloud=False)
print()
...
UNET.train_generator(datagen, x_tr, y_tr, x_te, y_te, epochs = 150, batch_size = 64)
